...
function Isaurainf(){
  ...
  function mostrarTentativa(partidas) {
      ...
      tituloo.innerText = partidas.Literatura[6].Titulo;
         ...
         <div className='center'>
          ...
          <div className='perfil'>
              ...
              <div id='Isaura-titulo1' className='titulo1'>
                ...
                <a href="https://drive.google.com/file/d/1vSNvNBH0BQk0SMrZXZUivyqSAh7pSfUN/view?usp=sharing"><button className='butao-baixar'>BAIXAR</button></a>
